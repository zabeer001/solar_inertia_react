    ...
    <div className="container mx-auto p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 bg-white p-6 rounded shadow" encType="multipart/form-data">
        ...
        <div>
          ...
          <input type="text" name="content_title" value={data.content_title} onChange={handleChange} className="w-full p-2 border rounded" />
        ...
        <div>
          ...
          <textarea name="content_description" value={data.content_description} onChange={handleChange} className="w-full p-2 border rounded" />
        ...
        <div>
          ...
          <input type="file" name="icon_image" onChange={handleFileChange} className="w-full p-2 border rounded" />
          {errors.icon_image && <span className="text-red-500">{errors.icon_image}</span>}
          {contentDetail?.icon_image_url && <img src={contentDetail.icon_image_url} alt="Icon Image Preview" className="w-20 mt-2" />}
        </div>
