...
const SalesTrackedForm = ({ salesTracked = {} }) => {
    ...
    return (
        <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-8 mt-10">
            <h1 className="text-3xl font-bold text-gray-800 mb-6 text-center">
                {salesTracked.id ? "Edit Sales Entry" : "Create Sales Entry"}
            </h1>
...
SalesTrackedForm.layout = (page) => <BackendLayout>{page}</BackendLayout>;

export default SalesTrackedForm;
